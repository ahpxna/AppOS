-- =========================================================
-- 031b — Recreate Profile Capability Review Views
-- Reason:
--   PostgreSQL cannot CREATE OR REPLACE VIEW when the new view changes
--   existing column order/name. Drop only the review views, then recreate.
-- =========================================================

DROP VIEW IF EXISTS v_profile_capability_asset_link_detail;
