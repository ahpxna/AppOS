...
none of these three bug classes exist anywhere in the current 60 files.
...
Use the next integer after the highest number present (currently `055`). Don't reuse a
